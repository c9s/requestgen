// Code generated by "requestgen -method GET -url /v1/bullet -debug -type NoParamRequest -responseType NoParamResponse -sharedRateLimiterTypeName DynamicPathRequest"; DO NOT EDIT.
...
func (n *NoParamRequest) GetQueryParameters() (url.Values, error) {
	...
	for _k, _v := range params {
		if n.isVarSlice(_v) {
			n.iterateSlice(_v, func(it interface{}) {
...
func (n *NoParamRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (n *NoParamRequest) isVarSlice(_v interface{}) bool {
