...
//go:generate go run ../../cmd/requestgen -debug -url /v1/order -type PlaceOrderRequest -responseType .Response -responseDataField Data -responseDataType .Order -prefix OdrReq -interfaceName OrderRequest
