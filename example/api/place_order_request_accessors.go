// Code generated by "requestgen -type PlaceOrderRequest -method GET -url /api/v1/bullet -debug -responseType Response ./example/api"; DO NOT EDIT.
...
func (p *PlaceOrderRequest) Do(ctx context.Context) (*Response, error) {
