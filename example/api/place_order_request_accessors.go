// Code generated by "requestgen -type PlaceOrderRequest -X GET -debug ./example/api"; DO NOT EDIT.
...
func (p *PlaceOrderRequest) Do(ctx context.Context) (interface{}, error) {
	...
	req, err := p.client.NewRequest("GET", "/api/v1/bullet-public", query, params)
	if err != nil {
		return nil, err
	}
