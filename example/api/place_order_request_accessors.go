// Code generated by "requestgen -type PlaceOrderRequest -method GET -url /api/v1/bullet -debug -responseType Response -responseDataField Data -responseDataType Order ./example/api"; DO NOT EDIT.
