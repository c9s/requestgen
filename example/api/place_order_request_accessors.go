// Code generated by "requestgen -type PlaceOrderRequest -method GET -url /api/v1/bullet -responseType .Response -responseDataField Data -responseDataType .Order ."; DO NOT EDIT.
