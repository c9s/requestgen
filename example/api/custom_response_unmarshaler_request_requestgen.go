// Code generated by "requestgen -type CustomResponseUnmarshalerRequest -url /v1/bullet -method GET -debug -responseType .CustomUnmarshalerResponse"; DO NOT EDIT.
...
func (c *CustomResponseUnmarshalerRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (c *CustomResponseUnmarshalerRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (c *CustomResponseUnmarshalerRequest) isVarSlice(_v interface{}) bool {
...
func (c *CustomResponseUnmarshalerRequest) Do(ctx context.Context) (*CustomUnmarshalerResponse, error) {
	...
	req, err := c.client.NewRequest(ctx, "GET", apiURL, query, params)
	if err != nil {
		return nil, err
	}
	...
	var apiResponse CustomUnmarshalerResponse
